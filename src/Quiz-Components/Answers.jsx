        ...
        return (
            <div id="answers">
                <ul>
                    ...
                    <span>A</span> 
                    <p dangerouslySetInnerHTML={{__html: answers[0]}}></p></li>

                    <li onClick={this.checkAnswer} 
                        className={classNames[1]} data-id="2">
                    <span>B</span> 
                    <p dangerouslySetInnerHTML={{__html: answers[1]}}></p></li>

                    <li onClick={this.checkAnswer} 
                        className={classNames[2]} data-id="3">
                    <span>C</span> 
                    <p dangerouslySetInnerHTML={{__html: answers[2]}}></p></li>

                    <li onClick={this.checkAnswer} 
                        className={classNames[3]} data-id="4">
                    <span >D</span> 
                    <p dangerouslySetInnerHTML={{__html: answers[3]}}></p></li>
                </ul>
            </div>
        );
    }
